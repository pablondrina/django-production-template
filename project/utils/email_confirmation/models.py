...
from . import get_email_address_model
...
from project.utils.tokens import email_activation_token
...
class SimpleEmailConfirmationUserMixin(object):
    ...
    def add_email_if_not_exists(self, email):
        ...
        try:
            ...
            if not address.is_email_confirmed:
...
class EmailAddressManager(models.Manager):
    ...
    def generate_key(self, user):
        ...
        # )
        return email_activation_token.make_token(user)
...
class AbstractEmailAddress(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = _("endereços de email")
        abstract = True
    ...
    def reset_confirmation(self):
        ...
        cease to work.
        """
        self.key = get_email_address_model()._default_manager.generate_key(self.user)
